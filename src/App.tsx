...
export default function App() {
  ...
  const activeAlerts = data.alerts.filter((a: any) => !a.resolved);
  const isCommandDeck = activeSection === "command";
  const isDataSources = activeSection === "datasources";
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 flex min-w-0 overflow-hidden">
          {loading ? (
            ...
            <DataSources />) : activeSection === "settings" ? (
            <AdminPortal />
          ) : !isCommandDeck ? (
            <AgentWorkspace section={activeSection} data={data} />
          ) : (
            <>
                ...
                <div className="flex gap-2 flex-1 min-h-0 overflow-hidden">
                  ...
                  <div className="flex-1 holo-card flex flex-col overflow-hidden relative glow-cyan">
                    <div className="flex items-center gap-2 px-3 py-1.5 border-b border-cyan-500/15 shrink-0">
                      ...
                      <span className="text-cyan-400 text-[9px] font-bold tracking-widest uppercase">
                        مركز العمليات العالمي
                      </span>
